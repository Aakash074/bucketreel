...
const Dashboard = () => {
    ...
    const [hederaClient, setHederaClient] = React.useState(null);
    ...
    return (_jsx("div", { children: !address ? _jsx("div", { className: 'w-screen flex justify-center items-center', children: _jsx(ConnectButton, {}) })
            :
                _jsxs("div", { className: 'w-screen h-screen flex flex-col justify-start', children: [_jsxs("div", { className: 'flex flex-row justify-between w-full p-4', children: [_jsxs("h2", { className: '', children: [" Welcome $", showFirstAndLast(address)] }), _jsx(Button, { onClick: () => { localStorage.clear(); disconnect(); }, children: "Logout / Disconnect" })] }), _jsxs("div", { className: 'flex flex-col justify-center mx-5 ', children: [_jsx(UploadComponent, { setFile: setFile }), file && _jsxs("div", { className: 'flex flex-row p-2 gap-2', children: [_jsx(Input, { placeholder: "Enter Location Name", value: value, onChange: handleChange }), _jsx(Button, { onClick: handleMint, children: "Mint" })] })] }), _jsx("div", { className: 'flex flex-col justify-center items-center gap-4', children: _jsx(NFTDisplay, {}) })] }) }));
};
